 ...
 */
public class Wuran_nintyeight extends Fragment {
    View rootView;
    ...
    ArrayList<String> wuran15 = new ArrayList<>();
        ...
        public void run() {
            if (stringBuffer.length() != 0) {
                ...
                if (msg.equals(SerialOrder.ORDER_OKSTART)) {
                    ...
                    if (mode.equals("自动")){
                        if (num != num_initial) {
                            wuran15.add(text15.getText().toString());
                    ...
                    if (num > 0) {
                        ...
                        try {
                            ...
                            intent.putStringArrayListExtra("wuran15", wuran15);
                            intent.putStringArrayListExtra("wuran925", wuran25);
                ...
                if (flag_start) {
                    ...
                    if (streamdata.startsWith("aa0010") && streamdata.endsWith("cc33c33c")) {
                        ...
                        text25.setText(String.valueOf(str));
                        text15.setText(String.valueOf(str2));
                        streamdata = "";
                    }
                }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.fragment_wuran_nintyeight, container, false);
