 ...
 */
public class Lvchuzero extends Fragment {
    View rootView;
        ...
        public void run() {
            if (stringBuffer.length() != 0) {
                ...
                if (msg.equals(SerialOrder.ORDER_OKSTART)) {
                    ...
                    if (mode.equals("自动")){
                        if (num !=num_initial) {
                            TextView text20 = (TextView) rootView.findViewById(R.id.text_20);
                            lvchu20.add(text20.getText().toString());
                        }
                    }else {
                        TextView text20 = (TextView) rootView.findViewById(R.id.text_20);
                        lvchu20.add(text20.getText().toString());
                    ...
                    if (num > 0) {
                        ...
                        try {
                            ...
                            intent.putStringArrayListExtra("lvchu20", lvchu20);
                ...
                if (flag_start) {
                    ...
                    if (streamdata.startsWith("aa0010") && streamdata.endsWith("cc33c33c")) {
                        // TODO: 2016/12/14 积分
                        int number = Integer.parseInt(streamdata.substring(6, 12), 16)
                        ...
                        text20.setText(String.valueOf(str));
                        streamdata = "";
                    }
                }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.fragment_lvchuzero, container, false);
