 ...
 */
public class Yaodian extends Fragment {
    View rootView;
        ...
        public void run() {
            if (stringBuffer.length() != 0) {
                ...
                if (msg.equals(SerialOrder.ORDER_OKSTART)) {
                    ...
                    if (mode.equals("自动")){
                        if (num != num_initial) {
                            yaodian15.add(text15.getText().toString());
                            yaodian25.add(text25.getText().toString());
                        }
                    }else {
                        yaodian15.add(text15.getText().toString());
                        yaodian25.add(text25.getText().toString());
                    ...
                    if (num > 0) {
                        ...
                        try {
                            ...
                            intent.putStringArrayListExtra("yaodian15", yaodian15);
                            intent.putStringArrayListExtra("yaodian25", yaodian25);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.fragment_yaodian, container, false);
